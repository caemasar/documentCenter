...
<body>
	<center>
		<div
			...
			用户注册界面</div>
		单击此处<a href="login_page.action">登录</a> <FONT color="red"><s:actionerror />
		</FONT>
		...
		用户验证码： <img id="img_validation_code" src="validate_code.action" /> <a
			href="#" onClick="refresh()">重新获得验证码</a>
	</center>
</body>
</html>
